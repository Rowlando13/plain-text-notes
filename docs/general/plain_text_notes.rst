...
.. code-block:: text
   ...
   point in time to my local repository. At some later time, I can merge with
...
*  There are only 3 division levels available in a document.
      ...
      *  The section name is indented 12 spaces, ie 3 tabs of 4 spaces. The number of spaces per tab may vary by user preference between 2 and 4.
